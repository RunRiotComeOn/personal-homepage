    ...
    <div className="site-shell">
      ...
      >
        ...
        <nav className={menuOpen ? 'site-nav is-open' : 'site-nav'}>
          <a className="atlas-nav-entry" href="./play-atlas/"><Gamepad2 size={18} /> PLAY ATLAS</a>
          {navLinks.map((link) => (
            <a
              key={link.href}
              href={link.href}
      ...
      <main id="top">
        <section className="hero-section" id="about">
          <div className="hero-copy">
            <a className="atlas-hero-entry" href="./play-atlas/">
              <span className="atlas-entry-icon"><Gamepad2 size={30} /></span>
              <span><small>EXPLORE MY PLAYABLE WORLD</small><strong>Play Atlas <ArrowUpRight size={27} /></strong><span>Become an orca. Find your own way through my ocean.</span></span>
            </a>
